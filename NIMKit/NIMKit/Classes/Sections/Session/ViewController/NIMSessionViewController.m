...
@interface NIMSessionViewController ()<NIMMediaManagerDelegate,NIMInputDelegate,MMEmotionCentreDelegate>
...
//    [[MMGifManager defaultManager] setSearchUiVisible:true withAttatchedView:_sessionInputView.toolBar];
    ...
    [MMGifManager defaultManager].selectedHandler = ^(MMGif * _Nullable gif) {
        ...
        if(tempSelf) {
            tempSelf.sessionInputView.toolBar.inputTextView.textView.text = nil;
